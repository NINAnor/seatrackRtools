...
```
    ...
    #> INFO [2025-12-04 12:11:18] Sea track folder set to: /tmp/RtmpqPOvNN/seatrack_vignette_26f220921f1c/SEATRACK - shared
...
#> SUCCESS [2025-12-04 12:11:19] Master import file for colony 'TestColony' found at: /tmp/RtmpqPOvNN/seatrack_vignette_26f220921f1c/SEATRACK - shared/Database/Imports_Metadata/imports_TestColony_2025.xlsx
#> [[1]]
#> NULL
#> 
#> [[2]]
...
#> SUCCESS [2025-12-04 12:11:19] Appended 1 rows to master metadata. New total is 2 rows.
```
...
#> SUCCESS [2025-12-04 12:11:19] Found unfinished session for logger ID: L1 2025-01-10
#> SUCCESS [2025-12-04 12:11:19] Unfinished session:
#>   logger_serial_no starttime_gmt       intended_species intended_location
#> 1 L1               2024-01-01 00:00:00 bird             TestColony       
#> SUCCESS [2025-12-04 12:11:19] Updated 1 sessions.
#> SUCCESS [2025-12-04 12:11:19] Updated sessions:
...
#> INFO [2025-12-04 12:11:19] Add missing sessions from start up files
#> INFO [2025-12-04 12:11:19] Append encounter data
#> SUCCESS [2025-12-04 12:11:19] Appended 1 rows to master metadata. New total is 2 rows.
#> INFO [2025-12-04 12:11:19] Update sessions from logger returns
#> SUCCESS [2025-12-04 12:11:19] Found unfinished session for logger ID: L1 2025-01-10
#> SUCCESS [2025-12-04 12:11:19] Unfinished session:
#>   logger_serial_no starttime_gmt       intended_species intended_location
#> 1 L1               2024-01-01 00:00:00 bird             TestColony       
#> SUCCESS [2025-12-04 12:11:20] Updated 1 sessions.
#> SUCCESS [2025-12-04 12:11:20] Updated sessions:
#>   logger_serial_no starttime_gmt       download_type download_date
#> 1 L1               2024-01-01 00:00:00 Downloaded    2025-01-10
