...
partner_sheets <- list(
  `ENCOUNTER DATA` = tibble::tibble(
    ...
    ring_number = "42",
    logger_model_deployed = NA,
    logger_id_deployed = NA,
    logger_model_retrieved = "birdtracker5000",
...
import_list <- list(
  METADATA = tibble::tibble(
    ...
    ring_number = "42",
    logger_model_deployed = "birdTracker5000",
  ...
  STARTUP_SHUTDOWN = tibble::tibble(
    ...
    project = "seatrack",
    starttime_gmt = as.POSIXct(as.Date("2024-01-01")),
    logging_mode = NA,
    started_by = NA,
...
openxlsx2::write_xlsx(import_list, full_colony_file_path, asTable = TRUE, na.strings = "")
```
