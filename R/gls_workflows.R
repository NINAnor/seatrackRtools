...
gls_prepare_upload <- function() {
    gls_directory_path <- file.path(the$sea_track_folder, "Database\\Imports_Logger data\\Output_GLSpositions")
    all_pos <- gls_prepare_folder_upload(gls_directory_path)
    return(all_pos)
}
